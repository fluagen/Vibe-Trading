...
_DEFAULT_PARAMS: dict[str, dict[str, Any]] = {
    ...
    "node_trading": {
        ...
        "r_s2_lower": 2.0,
        "r_s2_upper": 4.0,
        "reversal_vol_ratio": 1.0,
        "s2_reversal_r_min": 2.5,
        "support_ma_tolerance": 0.005,
        "s1_breakout_vol_ratio": 1.5,
        "reversal_low_r_size": 0.2,
        "reversal_high_r_size": 0.1,
        "reversal_r_boundary": 6.0,
        "support_s3_size": 0.5,
        "support_s4_size": 0.3,
        "sticky_breakout_size": 0.1,
        "hard_stop_pct": 0.05,
        "reversal_node_fail_days": 3,
        "tp_r_s5": 9.0,
        "tp_r_s4": 6.0,
    },
}
